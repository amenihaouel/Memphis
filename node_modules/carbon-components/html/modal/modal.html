<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ovcqhgoouzg">Show modal</button>

<div data-modal id="modal-ovcqhgoouzg" class="bx--modal " role="dialog" aria-modal="true" aria-labelledby="modal-ovcqhgoouzg-label" aria-describedby="modal-ovcqhgoouzg-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ovcqhgoouzg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ovcqhgoouzg-heading">Modal heading</p>
