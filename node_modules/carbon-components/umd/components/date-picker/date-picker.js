  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._initDatePicker = function (type) {
      if (type === 'range') {
        ...
        _this2.manage((0, _on2.default)(_this2.element, focusinEventName, _this2._handleFocus, !hasFocusin));
        _this2.manage((0, _on2.default)(_this2.element, focusoutEventName, _this2._handleBlur, !hasFocusout));
        _this2.manage((0, _on2.default)(_this2.element.querySelector(_this2.options.selectorDatePickerIcon), focusoutEventName, _this2._handleBlur, !hasFocusout));
        ...
        _this2.manage((0, _on2.default)(doc, 'mousedown', function () {
    ...
    this._addInputLogic = function (input, index) {
      ...
      _this2.manage((0, _on2.default)(inputField, 'keydown', function (evt) {
