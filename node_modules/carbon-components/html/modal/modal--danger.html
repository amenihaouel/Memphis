<button class="bx--btn bx--btn--danger--primary" type="button" data-modal-target="#modal-84jr1jhd83p">Show modal</button>

<div data-modal id="modal-84jr1jhd83p" class="bx--modal bx--modal--danger" role="dialog" aria-modal="true" aria-labelledby="modal-84jr1jhd83p-label" aria-describedby="modal-84jr1jhd83p-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-84jr1jhd83p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-84jr1jhd83p-heading">Modal heading</p>
